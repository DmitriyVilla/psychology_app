...
class AppColors {
  ...
  static const darkSecondary = Color(0xFFDBF2FF); // для второстепенных акцентов
  ...
  static const textSecondaryLight = Color.fromARGB(255, 255, 255, 255); //  для светлой темы
